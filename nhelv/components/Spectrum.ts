...
import { additiveBlending, Color, color, createSprite, DefaultPallete, fade, Layer, Origin, scaleVec } from '@osbjs/tiny-osbjs'
 ...
 */
export default function Spectrum(startTime: number, endTime: number, schemaPath: string, spritePath: string, options?: SpectrumOptions) {
